package moonbeam.com.psychometrycalculator;
...
public class PsychometryFormulas {
    ...
    static final int[] QUAN_SCORE_ARRAY = new int[] {50, 52, 54, 56, 58, 60, 62, 64, 66, 68, 70, 73, 75, 78, 80, 83, 86, 89, 92, 94, 97, 99, 102, 105, 107, 110, 113, 115, 118, 120, 123, 126, 128, 131, 134, 137, 139, 142, 145, 147, 150};
    static final int[] VERBAL_SCORES_ARRAY = new int []{50, 51, 53, 54, 55, 57, 58, 59, 61, 62, 63, 64, 66, 67, 68, 70, 72, 73, 75, 78, 81, 84, 87, 90, 93, 96, 99, 102, 105, 109, 112, 116, 120, 123, 127, 130, 134, 138, 142, 146, 150};
    static final int[] ENG_SCORES_ARRAY = new int[]{50, 51, 52, 53, 54, 56, 58, 60, 62, 64, 66, 68, 70, 72, 74, 76, 78, 80, 82, 84, 87, 90, 92, 95, 98, 100, 102, 104, 107, 110, 112, 115, 117, 120, 122, 124, 127, 130, 132, 135, 138, 141, 144, 147, 150};
    ...
    public static int getSectionScore(Section section, int numOfSections, int correctAnswers){
        int averageScore = correctAnswers/numOfSections*2;
        switch (section){
            case QUAN:
    ...
    public static Range getGeneralWeightedScore(int mathScore, int verbalScore, int engScore){
